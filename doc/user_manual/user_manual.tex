...
A list of suggestions for this example (truncated to only the most important recommendation) is shown following. Each entry in this list is similar to the following one:

% TODO: update this recommendation
{{\begin{verbatim}
