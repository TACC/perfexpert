...
\btt recommender -f \tt\underline{in}p\underline{utfile} \btt [ -o \tt\underline{out}p\underline{utfile} \btt ] [ -a \tt\underline{workdir} \btt ] [ -r \tt\underline{count} \btt ] [ -d \tt\underline{database} \btt ]\par
\ \ \ \ \ \ \ \ \ \btt [ -m \tt\underline{metricsfile} \btt ] [ -l \tt\underline{level} \btt ] [ -chnv ]\normalfont
