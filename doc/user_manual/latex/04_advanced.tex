...
This module provides the most common functionality that users require. It analyzes the data collected by the measurement
module. The information that this module generates can be later on used by the \texttt{recommender} module \cite{recommender}
