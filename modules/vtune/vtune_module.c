...
int module_measure(void) {
    ...
    //Add the individual profile to the list of profiles (global to the module)
    // TODO: this line makes lcpi fail. I have to figure out why
    //perfexpert_list_append (&(myself_module.profiles), (perfexpert_list_item_t *) profile);
