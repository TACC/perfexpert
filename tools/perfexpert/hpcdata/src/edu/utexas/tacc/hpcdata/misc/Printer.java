...
public class Printer
{
	...
	public static void putHeader(String version, String header, String profile)
	{
		outStream.print ("<HPCToolkitExperiment version=\"" + version + "\">\n<Header n=\"" + header + "\">\n  <Info/>\n</Header>\n<SecFlatProfile i=\"0\" n=\"" + profile + "\">\n<SecHeader>\n <MetricTable>\n");
	}

	public static void putMetric(long i, String metric)
	{
		outStream.print ("    <Metric i=\"" + i + "\" n=\"" + metric + " (E)\" v=\"final\" t=\"exclusive\" s=\"1\"> </Metric>\n");
	}
	...
	{
		outStream.print ("<C i=\"0\" l=\"0\"><PF i=\"" + n + "\" n=\"" + name + "\" l=\"" + l + "\"/></C>");
	}
