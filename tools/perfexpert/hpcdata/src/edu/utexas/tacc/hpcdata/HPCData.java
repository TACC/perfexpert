...
public class HPCData
{
	...
	public static void main(String args[]) throws Exception
	{
		...
		FlaggedOption flOutput = new FlaggedOption('o', "output", "Output file", "file", true, ArgType.STRING);
		UnflaggedOption ufExp = new UnflaggedOption("experiment.xml", "experiment.xml file to be converted", ArgType.STRING);
