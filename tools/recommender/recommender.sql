...
-- Create tables
--
CREATE TABLE IF NOT EXISTS recommender_category (
    id    INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS recommender_pattern (
    ...
    name       VARCHAR NOT NULL,
    FOREIGN KEY (language) REFERENCES recommender_language(id)
);

CREATE TABLE IF NOT EXISTS recommender_transformation (
    id          INTEGER PRIMARY KEY,
    language    INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS recommender_architecture (
    id    INTEGER PRIMARY KEY,
    name  VARCHAR,
    short VARCHAR
);

CREATE TABLE IF NOT EXISTS recommender_strategy (
    id        INTEGER PRIMARY KEY,
    name      VARCHAR NOT NULL,
    statement VARCHAR NOT NULL
);

CREATE TABLE IF NOT EXISTS recommender_ra (
    rid INTEGER NOT NULL,
    aid INTEGER NOT NULL,
    FOREIGN KEY (rid) REFERENCES recommender_recommendation(id),
    FOREIGN KEY (aid) REFERENCES recommender_architecture(id)
);

CREATE TABLE IF NOT EXISTS recommender_rt (
    rid INTEGER NOT NULL,
    tid INTEGER NOT NULL,
    FOREIGN KEY (rid) REFERENCES recommender_recommendation(id),
    FOREIGN KEY (tid) REFERENCES recommender_transformation(id)
);

CREATE TABLE IF NOT EXISTS recommender_tp (
    tid INTEGER NOT NULL,
    pid INTEGER NOT NULL,
    FOREIGN KEY (tid) REFERENCES recommender_transformation(id),
    FOREIGN KEY (pid) REFERENCES recommender_pattern(id)
);

CREATE TABLE IF NOT EXISTS recommender_rc (
    rid    INTEGER NOT NULL,
    cid    INTEGER NOT NULL,
    weight REAL DEFAULT 1,
    FOREIGN KEY (cid) REFERENCES recommender_category(id),
    FOREIGN KEY (rid) REFERENCES recommender_recommendation(id)
);

CREATE TABLE IF NOT EXISTS recommender_rf (
    rid    INTEGER NOT NULL,
    fid    INTEGER NOT NULL,
    weight REAL,
    FOREIGN KEY (rid) REFERENCES recommender_recommendation(id),
    FOREIGN KEY (fid) REFERENCES recommender_function(id)
);
...
INSERT INTO recommender_category (id, short, name) VALUES
...
INSERT INTO recommender_recommendation (id, name, reason, example, depth) VALUES
...
INSERT INTO recommender_rc (rid, cid) VALUES (1, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (2, 8);
INSERT INTO recommender_rc (rid, cid) VALUES (2, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (3, 8);
INSERT INTO recommender_rc (rid, cid) VALUES (3, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (4, 8);
INSERT INTO recommender_rc (rid, cid) VALUES (4, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (5, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (5, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (6, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (7, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (8, 9);
INSERT INTO recommender_rc (rid, cid) VALUES (9, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (10, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (11, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (12, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (13, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (14, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (15, 7);
INSERT INTO recommender_rc (rid, cid) VALUES (16, 6);
INSERT INTO recommender_rc (rid, cid) VALUES (17, 6);
INSERT INTO recommender_rc (rid, cid) VALUES (18, 5);
INSERT INTO recommender_rc (rid, cid) VALUES (19, 5);
INSERT INTO recommender_rc (rid, cid) VALUES (19, 6);
INSERT INTO recommender_rc (rid, cid) VALUES (20, 5);
INSERT INTO recommender_rc (rid, cid) VALUES (21, 5);
INSERT INTO recommender_rc (rid, cid) VALUES (22, 5);
INSERT INTO recommender_rc (rid, cid) VALUES (23, 5);
INSERT INTO recommender_rc (rid, cid) VALUES (24, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (25, 2);
INSERT INTO recommender_rc (rid, cid) VALUES (25, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (26, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (27, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (28, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (29, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (30, 2);
INSERT INTO recommender_rc (rid, cid) VALUES (30, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (31, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (31, 4);
INSERT INTO recommender_rc (rid, cid) VALUES (32, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (33, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (34, 2);
INSERT INTO recommender_rc (rid, cid) VALUES (34, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (35, 2);
INSERT INTO recommender_rc (rid, cid) VALUES (35, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (36, 2);
INSERT INTO recommender_rc (rid, cid) VALUES (36, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (37, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (37, 4);
INSERT INTO recommender_rc (rid, cid) VALUES (38, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (39, 1);
INSERT INTO recommender_rc (rid, cid) VALUES (39, 2);
INSERT INTO recommender_rc (rid, cid) VALUES (39, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (40, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (41, 3);
INSERT INTO recommender_rc (rid, cid) VALUES (42, 3);

INSERT INTO recommender_pattern (id, language, recognizer, name) VALUES
    (1, 1, 'nested_c_loops', 'recognize two or more perfect nested loops');

INSERT INTO recommender_transformation (id, language, transformer, name) VALUES
    (1, 1, 'loop_interchange', 'interchange two perfect nested loops');
INSERT INTO recommender_transformation (id, language, transformer, name) VALUES
    (2, 1, 'loop_tiling', 'tile two perfect nested loops');

INSERT INTO recommender_rt (rid, tid) VALUES (31, 1);
INSERT INTO recommender_rt (rid, tid) VALUES (32, 1);

INSERT INTO recommender_tp (tid, pid) VALUES (1, 1);
INSERT INTO recommender_tp (tid, pid) VALUES (2, 1);
...
--
INSERT INTO recommender_strategy (name, statement) VALUES
    ('AutoSCOPE recommendation algorithm',
    "SELECT
    recommender_recommendation.id,
    SUM(
        lcpi_metric.value - (maximum * 0.1)
    ) AS score
FROM
    recommender_recommendation
INNER JOIN recommender_rc ON recommender_recommendation.id = recommender_rc.rid
INNER JOIN recommender_category ON recommender_category.id = recommender_rc.cid
JOIN lcpi_metric ON recommender_category.name = lcpi_metric.name
JOIN (
    SELECT
...
WHERE
    (
        recommender_recommendation.depth <= hotspot.depth
    )
